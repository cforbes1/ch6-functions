...
is_twice_as_long <- function(first_string, second_string) {
  return(nchar(first_string) == 2 * nchar(second_string) | 
    2 * nchar(first_string) == nchar(second_string))
}
...
describe_difference <- function(a, b) {
  ...
  if (a_length > b_length) {
    ...
    print(paste("Your secong string is longer by", difference, "characters"))
  } else {
